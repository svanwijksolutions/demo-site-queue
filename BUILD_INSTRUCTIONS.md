...
Schrijf een conceptpitchmail (Nederlands, zonder stijlstreepjes, eerlijk, onderbouwd, geen overdreven claims, vermeld expliciet als de huidige site niet volledig kon worden ingezien). Benoem daarin ook concreet welke waarde een goede website oplevert voor de ondernemer (bijv. beter vindbaar in Google door goede SEO, wat kan bijdragen aan meer aanvragen/klanten; een professionelere eerste indruk; mobielvriendelijkheid), realistisch en zonder overdrijving, zie RULES.md sectie "Pitchmail". Rapporteer aan het eind in platte tekst terug, dit is je hele deliverable, jij schrijft zelf niets naar demo-site-queue: status (succes/needs_review+reden), repo-link, live-URL, of foto's en/of meertaligheid gebruikt zijn, en de volledige tekst van de conceptpitchmail.
